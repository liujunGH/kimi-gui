export default {
  ...
  agentError: {
    ...
    agent: 'Subagent operation failed',
    skill: 'Skill loading failed',
    task: 'Background task failed',
    mcp: 'MCP operation failed',
    storage: 'Local storage operation failed',
    web: 'Web request failed',
    cron: 'Scheduled task configuration failed',
    wire: 'Session data migration failed',
  },
  details: {
    cause: 'Cause',
    code: 'Error code',
  ...
  copied: 'Copied',
  configTitle: 'Kimi configuration needs attention',
